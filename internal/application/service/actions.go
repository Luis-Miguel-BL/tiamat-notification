...
type SaveActionsService struct {
	campaignRepo repository.CampaignRepository
}

func NewSaveActionsService(campaignRepo repository.CampaignRepository) *SaveActionsService {
	return &SaveActionsService{
		campaignRepo: campaignRepo,
	}
}

func (uc *SaveActionsService) SaveActions(ctx context.Context, input input.SaveActionsInput) (err error) {
	err = input.Validate()
	if err != nil {
		return err
	}
